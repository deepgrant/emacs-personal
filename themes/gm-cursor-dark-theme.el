...
(let ((bg "#181818") (panel "#141414") (line "#262626")
  ...
  (custom-theme-set-faces
   ...
   `(minimap-font-face ((t (:family "Menlo" :height 30 :background ,panel :foreground ,dim))))
   `(minimap-active-region-background ((t (:background ,selection :extend t))))
   `(minimap-current-line-face ((t (:background ,blue :foreground ,panel :extend t))))
